...
class NestedReadObject {
  ...
  factory NestedReadObject.fromMap(Map<String, dynamic> map) {
    return NestedReadObject(
      nestedNumber:
          map['nestedNumber'] != null ? map['nestedNumber'] as String : null,
      nestedString:
          map['nestedString'] != null ? map['nestedString'] as String : null,
    );
  }

  String toJson() => json.encode(toMap());

  factory NestedReadObject.fromJson(String source) =>
      NestedReadObject.fromMap(json.decode(source) as Map<String, dynamic>);

  @override
  String toString() =>
      'NestedReadObject(nestedNumber: $nestedNumber, nestedString: $nestedString)';

  @override
  bool operator ==(covariant NestedReadObject other) {
    if (identical(this, other)) return true;

    return other.nestedNumber == nestedNumber &&
